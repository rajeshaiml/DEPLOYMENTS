...
'''
test_text="accuracy using Multinomial Naive Bayes model"
test_countvectorizer = pickle.load(open('countvectorizer.pkl','rb'))
tt=test_countvectorizer.transform([test_text])
tt.shape
